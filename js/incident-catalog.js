...
const INCIDENT_DEFAULT_POLICIES={
  ...
  onboard_medical:{mode:'flightdeck_default',label:'medical plan',summary:'If OCC does not complete the case before the deadline, medical advisory and the captain may request continuation or diversion; OCC must still coordinate the chosen support.'},
  inflight_technical_fault:{mode:'flightdeck_default',label:'flight deck plan',summary:'If OCC does not complete the case before the deadline, the flight deck may request continuation or diversion after maintenance-control guidance; OCC must still coordinate the chosen support.'},
  ...
  unruly_passenger:{mode:'flightdeck_default',label:'security plan',summary:'If OCC does not complete the case before the deadline, the captain may request continuation or diversion; OCC must still coordinate security support.'},
  ...
  lightning_strike:{mode:'flightdeck_default',label:'flight deck plan',summary:'If OCC does not complete the case before the deadline, the flight deck may request continuation or diversion after systems checks; OCC must still coordinate inspection support.'},
  pressurization_issue:{mode:'flightdeck_default',label:'flight deck plan',summary:'If OCC does not complete the case before the deadline, the flight deck may request lower-altitude continuation or diversion; OCC must still coordinate fuel and arrival support.'}
};
