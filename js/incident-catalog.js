...
const INCIDENT_DEFAULT_POLICIES={
  ...
  destination_weather_deterioration:{mode:'flightdeck_default',label:'weather plan',summary:'If OCC does not complete the case before the deadline, the flight deck may request monitor, hold, or diversion using the latest weather picture; OCC must still coordinate the chosen support.'},
