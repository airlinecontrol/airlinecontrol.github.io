...
(function(global){
  ...
  const PROFILES={
    ...
    FDH:{wind:14,risk:.25,climate:'continental'}, PAD:{wind:18,risk:.25,climate:'continental'},
    GRZ:{wind:13,risk:.23,climate:'continental'}, BOO:{wind:27,risk:.34,climate:'nordic'},
    AVL:{wind:14,risk:.26,climate:'highland'}, BGR:{wind:20,risk:.30,climate:'continental'},
    BLI:{wind:19,risk:.30,climate:'maritime'}, CJC:{wind:22,risk:.10,climate:'desert'},
    ZCO:{wind:17,risk:.29,climate:'maritime'}, USM:{wind:16,risk:.34,climate:'tropical'},
    LPT:{wind:10,risk:.29,climate:'tropical'}, MYJ:{wind:17,risk:.25,climate:'coastal'},
    KCZ:{wind:19,risk:.31,climate:'coastal'}, CFS:{wind:18,risk:.27,climate:'coastal'},
    DBO:{wind:16,risk:.18,climate:'dry'}, ZQN:{wind:19,risk:.28,climate:'alpine'},
    PIT:{wind:17,risk:.26,climate:'continental'}, RIC:{wind:15,risk:.24,climate:'continental'},
    CHS:{wind:18,risk:.29,climate:'coastal'}, ALB:{wind:18,risk:.29,climate:'continental'},
    YVR:{wind:19,risk:.30,climate:'maritime'}, YYC:{wind:23,risk:.28,climate:'highland'},
    YHZ:{wind:24,risk:.33,climate:'maritime'}, BDA:{wind:24,risk:.32,climate:'coastal'},
    HAM:{wind:21,risk:.28,climate:'maritime'}, BER:{wind:18,risk:.23,climate:'continental'},
    BRS:{wind:22,risk:.29,climate:'maritime'}, EDI:{wind:25,risk:.32,climate:'maritime'},
    BGO:{wind:24,risk:.35,climate:'maritime'}, SVG:{wind:26,risk:.33,climate:'maritime'},
    PEK:{wind:18,risk:.25,climate:'continental'}, SZX:{wind:18,risk:.34,climate:'tropical'},
    HGH:{wind:16,risk:.29,climate:'coastal'}, XMN:{wind:20,risk:.32,climate:'coastal'},
    KIX:{wind:22,risk:.29,climate:'coastal'}, FUK:{wind:19,risk:.28,climate:'coastal'},
    CNX:{wind:11,risk:.28,climate:'tropical'}, HKT:{wind:17,risk:.35,climate:'tropical'},
    CLE:{wind:22,risk:.30,climate:'continental'}, CMH:{wind:18,risk:.26,climate:'continental'},
    CVG:{wind:17,risk:.26,climate:'continental'}, IND:{wind:20,risk:.28,climate:'continental'},
    MCI:{wind:22,risk:.28,climate:'continental'}, STL:{wind:18,risk:.27,climate:'continental'},
    MKE:{wind:23,risk:.30,climate:'continental'}, MEM:{wind:17,risk:.27,climate:'continental'},
    SDF:{wind:17,risk:.27,climate:'continental'}, JAX:{wind:17,risk:.31,climate:'tropical'},
    PNS:{wind:19,risk:.31,climate:'coastal'}, PWM:{wind:22,risk:.31,climate:'maritime'},
    BUF:{wind:23,risk:.33,climate:'continental'}, SYR:{wind:19,risk:.32,climate:'continental'},
    SMF:{wind:15,risk:.19,climate:'mediterranean'}, RNO:{wind:20,risk:.23,climate:'highland'},
    BOI:{wind:17,risk:.21,climate:'dry'}, GEG:{wind:18,risk:.26,climate:'continental'},
    YUL:{wind:20,risk:.30,climate:'continental'}, YOW:{wind:18,risk:.29,climate:'continental'},
    YQB:{wind:20,risk:.33,climate:'continental'}, YWG:{wind:22,risk:.31,climate:'continental'},
    YEG:{wind:19,risk:.29,climate:'continental'}, YYJ:{wind:20,risk:.28,climate:'maritime'},
    MTY:{wind:17,risk:.20,climate:'dry'}, GDL:{wind:14,risk:.24,climate:'highland'},
    CUN:{wind:20,risk:.35,climate:'tropical'}, SJD:{wind:18,risk:.16,climate:'desert'}
  };
  const PHENOMENA={
